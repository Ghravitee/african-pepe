  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row justify-center items-center lg:justify-between lg:items-start w-full px-5 py-10 lg:px-20 lg:py-28">
      <div className="lg:w-[33.3%] w-full">
        ...
        <div className="w-full md:max-w-[60rem]">
          <motion.div
            ...
            variants={fadeIn("right", "tween", 0, 0.5)}
            viewport={{ once: true }}
            className="text-white text-center textWithShadow2 font1 text-[2rem] lg:text-left lg:text-[2.5rem] lg:px-0 lg:max-w-[30rem] uppercase font-bold leading-10 tracking-wider"
          >
      ...
      <motion.div
        ...
        whileInView="show"
        viewport={{ once: true }}
        className="w-[70%] lg:w-[33.3%] relative mb-6 lg:mb-0"
      >
        <Image
          src={"/hero-1.png"}
          width={450}
