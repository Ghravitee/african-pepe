  ...
  return (
    <>
      <div className=" relative lg:border-b-[16px] lg:border-b-white">
        <div className="box1 bg-green-500 -z-50 absolute top-[3rem] left-[10%] lg:left-[4%]"></div>
        <div className="box1 bg-[#ff0054] -z-50 absolute top-[3rem] right-5 lg:top-[17rem] lg:left-[23%]"></div>
